...
<div id="app">
  ...
  <main class="main-info">
    <span class="name">Julia Delfina</span>
    <h3>Text that she's saying.</h3>
  </main>
  
  <ul>
    <li id="app-comment" v-for="comment in comments" :key="comment" :comment="comment"></li>
  </ul>
  
  <br>
  
  <label for="stuff">Write a comment:</label>
  <input type="text" id="stuff" v-model="newComment" @keyup.enter="submitComment">
